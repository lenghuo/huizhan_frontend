...
<template>
  <div class="containerComponent"><!---->
    <div class="header whiteBg simple-style">
      <div class="tongfa_box notHomeStyle zh-cn">
        <div class="head_content">
          <div class="head_icon"><img
              src="https://cultureexpo-prod-1302844417.cos.ap-guangzhou.myqcloud.com//module/img/20230424/f668ed8d81dd4fb1b6541d7c532f77ba.png"
              alt="" height="42"></div>
          <div class="rigth_box">
            <div class="searchInput" style="height: 48px; margin-right: 25px; margin-top: 30px;">
              
            </div>
          </div>
          <ul class="ul_class simple-style blue">
            <li class="item_name_li active">
              首页
            </li>
            <li class="item_name_li">
              新闻
            </li>
            <li class="item_name_li" style="">
              展馆
            </li>
            <li class="item_name_li">
              展商
            ...
            <li class="item_name_li">
              <div class="langs_drop el-dropdown">
                <span class="about-us-tab el-dropdown-selfdefine" aria-haspopup="list" aria-controls="dropdown-menu-5570"
                  role="button" tabindex="0">活动</span>
                <ul class="el-dropdown-menu el-popper" id="dropdown-menu-5570" style="display: none;">
                  <li tabindex="-1" class="el-dropdown-menu__item simple-style blue"><!---->官方直播</li>
                  <li tabindex="-1" class="el-dropdown-menu__item simple-style blue"><!---->展商直播</li>
                  <li tabindex="-1" class="el-dropdown-menu__item simple-style blue"><!---->票证大厅</li>
                  <li tabindex="-1" class="el-dropdown-menu__item simple-style blue"><!---->展会服务</li>
                </ul>
              </div>
            </li>
            <li class="division"><img src="" width="28" height="18" alt=""><span>VR展馆</span></li>
          </ul>
          <div class="opera">
            <div class="opera-item langs">
              <div class="langs_drop el-dropdown"><span class="langTxet_box"> EN</span></div>
            </div>
            <div class="opera-item">登录</div>
            <div class="opera-item" style="padding-right: 10px;">
              <div class="rightBox el-dropdown">
                <div class="right el-dropdown-selfdefine" aria-haspopup="list" aria-controls="dropdown-menu-7324"
                  role="button" tabindex="0">
                  报名
                </div>
                <ul class="el-dropdown-menu el-popper dropdown" id="dropdown-menu-7324" style="display: none;">
            ...
            <div class="opera-item" style="padding-left: 10px;">
              <div class="rightBox el-dropdown">
                <div class="right el-dropdown-selfdefine" aria-haspopup="list" aria-controls="dropdown-menu-8381"
                  role="button" tabindex="0">
                  注册
                </div>
                <ul class="el-dropdown-menu el-popper dropdown" id="dropdown-menu-8381" style="display: none;">
                  <li tabindex="-1" class="el-dropdown-menu__item"><!---->
                    <div>注册</div>
                  </li>
                  <li tabindex="-1" class="el-dropdown-menu__item"><!---->
    ...
    <div class="el-dialog__wrapper login" style="display: none;">
      <div role="dialog" aria-modal="true" aria-label="账号登录" class="el-dialog" style="margin-top: 25vh; width: 360px;">
        <div class="el-dialog__header"><span class="el-dialog__title">账号登录</span><button type="button" aria-label="Close"
